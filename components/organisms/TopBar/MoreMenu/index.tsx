...
import {
  MoreHorizontal, Upload, Download, Map, BookOpen, Settings, Keyboard, Trash2,
} from "lucide-react";
...
export function MoreMenu({ onImport, onExport, onSettings, onShortcuts, onClearWorkspace, nodesCount }: MoreMenuProps) {
    ...
    <div ref={ref} className={style.moreWrapper}>
      <Tooltip>
        <TooltipTrigger asChild>
          <Button variant="ghost" size="icon-sm" onClick={() => setOpen((v) => !v)} aria-label="More options">
