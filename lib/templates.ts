    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          actionType: "trigger",
          event: "QuestStarted",
          params: { questId: "wolves_of_thornwood" },
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          actionType: "trigger",
          event: "StartCombat",
          params: { encounter: "bandit_ambush" },
          executionMode: "immediate",
          label: "Start Combat",
          attributeSchema: [],
          attributes: {},
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          actionType: "trigger",
          event: "HighlightUI",
          params: { target: "movement_controls" },
          executionMode: "immediate",
